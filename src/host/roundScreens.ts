...
/**
 * Round intro and result screens for Schaetzorama.
 *
...
function renderIntro(scene: Phaser.Scene, state: RoundScreenState): void {
  ...
  addText(
    ...
    schaetzoramaManifest.displayName,
    {
...
function renderResult(scene: Phaser.Scene, state: RoundScreenState): void {
  ...
  addText(scene, layer, panelX, 122, state.message ?? schaetzoramaManifest.displayName, {
    fontFamily: theme.bodyFont,
    fontSize: "20px",
    color: theme.muted,
